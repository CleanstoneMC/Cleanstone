...
class Property
{
    const BLOCK_NAME_ENUM_OVERRIDE = [
        ...
        // 1.14
        'smooth_stone_slab' => ['type' => 'HalfBlockPosition'],
        'cut_sandstone_slab' => ['type' => 'HalfBlockPosition'],
        'cut_red_sandstone_slab' => ['type' => 'HalfBlockPosition'],
        'polished_granite_slab' => ['type' => 'HalfBlockPosition'],
        'polished_diorite_slab' => ['type' => 'HalfBlockPosition'],
        'polished_andesite_slab' => ['type' => 'HalfBlockPosition'],
        'polished_granite_stairs' => ['half' => 'StairHalf', 'shape' => 'StairShape'],
        'polished_diorite_stairs' => ['half' => 'StairHalf', 'shape' => 'StairShape'],
        'polished_andesite_stairs' => ['half' => 'StairHalf', 'shape' => 'StairShape'],
        'smooth_red_sandstone_stairs' => ['half' => 'StairHalf', 'shape' => 'StairShape'],
        'smooth_red_sandstone_slab' => ['type' => 'HalfBlockPosition'],
        'mossy_stone_brick_stairs' => ['half' => 'StairHalf', 'shape' => 'StairShape'],
        'mossy_stone_brick_slab' => ['type' => 'HalfBlockPosition'],
        'mossy_cobblestone_stairs' =>  ['half' => 'StairHalf', 'shape' => 'StairShape'],
        'mossy_cobblestone_slab'  => ['type' => 'HalfBlockPosition'],
        'end_stone_brick_stairs' =>  ['half' => 'StairHalf', 'shape' => 'StairShape'],
        'end_stone_brick_slab'=> ['type' => 'HalfBlockPosition'],
        'stone_stairs' =>  ['half' => 'StairHalf', 'shape' => 'StairShape'],
        'granite_stairs' =>  ['half' => 'StairHalf', 'shape' => 'StairShape'],
        'andesite_stairs' =>  ['half' => 'StairHalf', 'shape' => 'StairShape'],
        'diorite_stairs' =>  ['half' => 'StairHalf', 'shape' => 'StairShape'],
        'granite_slab' => ['type' => 'HalfBlockPosition'],
        'andesite_slab'  => ['type' => 'HalfBlockPosition'],
        'diorite_slab'  => ['type' => 'HalfBlockPosition'],
        'smooth_sandstone_stairs' =>  ['half' => 'StairHalf', 'shape' => 'StairShape'],
        'smooth_sandstone_slab'  => ['type' => 'HalfBlockPosition'],
        'smooth_quartz_slab'  => ['type' => 'HalfBlockPosition'],
        'smooth_quartz_stairs' =>  ['half' => 'StairHalf', 'shape' => 'StairShape'],
        'red_nether_brick_stairs' =>  ['half' => 'StairHalf', 'shape' => 'StairShape'],
        'red_nether_brick_slab'  => ['type' => 'HalfBlockPosition'],
        'bell'  => ['attachment' => 'BellAttachment'],
