        ...
        val provider = TypeSpec.classBuilder("VanillaItemTypeProvider_v${getVersionString()}")
                ...
                .addMethod(MethodSpec.methodBuilder("registerVanillaItemTypes")
                        ...
                        .addStatement("\$T.stream(\$T.values()).forEach(\$L::registerItemType)",
                                ...
                                ClassName.get("rocks.cleanstone.endpoint.minecraft.vanilla.v${getVersionString()}.item", "VanillaItemType_v${getVersionString()}"),
                                "materialRegistry")
                        .build())
                .addJavadoc("A list of Cleanstone's item types\n" +
                        "!! GENERATED FILE. This file was generated by gradle. !!")

        JavaFile.builder("rocks.cleanstone.endpoint.minecraft.vanilla.v${getVersionString()}.item", provider.build())
                .skipJavaLangImports(true)
                .indent("    ")
                .build()
                .writeTo(srcRoot.toPath())
