package rocks.cleanstone.endpoint.minecraft.vanilla.modern.v1_13_1.net.protocol.outbound;
...
public class BlockChangeCodec implements OutboundPacketCodec<BlockChangePacket> {
    ...
    public BlockChangeCodec(@Qualifier("protocolBlockStateMapping_v1_13_1") BlockStateMapping<Integer> blockStateMapping) {
