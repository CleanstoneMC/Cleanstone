...
import rocks.cleanstone.endpoint.minecraft.vanilla.net.entity.data.ProtocolEntitySchemeLoader;
import rocks.cleanstone.endpoint.minecraft.vanilla.net.entity.metadata.EntityConverterRegistry;
