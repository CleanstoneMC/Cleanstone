package rocks.cleanstone.endpoint.minecraft.vanilla.v1_13_1.net.protocol;

import org.springframework.beans.factory.annotation.Autowired;
import org.springframework.stereotype.Component;
import rocks.cleanstone.endpoint.minecraft.vanilla.net.protocol.MinecraftClientProtocolLayer;
import rocks.cleanstone.endpoint.minecraft.vanilla.v1_13.net.protocol.MinecraftProtocolLayer_v1_13;
import rocks.cleanstone.endpoint.minecraft.vanilla.v1_13_1.net.protocol.inbound.CreativeInventoryActionCodec;
import rocks.cleanstone.endpoint.minecraft.vanilla.v1_13_1.net.protocol.outbound.BlockChangeCodec;
import rocks.cleanstone.endpoint.minecraft.vanilla.v1_13_1.net.protocol.outbound.ChunkDataCodec;
