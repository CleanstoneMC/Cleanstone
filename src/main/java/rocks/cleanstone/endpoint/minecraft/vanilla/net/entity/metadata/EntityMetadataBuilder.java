...
import rocks.cleanstone.endpoint.minecraft.vanilla.net.entity.data.ProtocolEntitySchemeMetadataEntry;
import rocks.cleanstone.endpoint.minecraft.vanilla.net.entity.data.ProtocolEntitySchemeNode;
