package rocks.cleanstone.endpoint.minecraft.vanilla.v1_13.net.protocol;
...
import rocks.cleanstone.endpoint.minecraft.vanilla.v1_13.net.protocol.inbound.CreativeInventoryActionCodec;
import rocks.cleanstone.endpoint.minecraft.vanilla.v1_13.net.protocol.inbound.InTabCompleteCodec;
import rocks.cleanstone.endpoint.minecraft.vanilla.v1_13.net.protocol.outbound.BlockChangeCodec;
import rocks.cleanstone.endpoint.minecraft.vanilla.v1_13.net.protocol.outbound.ChunkDataCodec;
...
public class MinecraftProtocolLayer_v1_13 extends AutowiredServerProtocolLayer {
    ...
    public MinecraftProtocolLayer_v1_13(List<? extends PacketCodec<? extends Packet>> packetCodecs) {
        ...
        registerPacketCodec(PlayerCodec.class, PLAY, 0x0F);
