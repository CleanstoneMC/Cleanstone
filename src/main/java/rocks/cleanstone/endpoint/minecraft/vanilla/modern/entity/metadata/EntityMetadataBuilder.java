package rocks.cleanstone.endpoint.minecraft.vanilla.modern.entity.metadata;

import com.google.common.base.Preconditions;
import rocks.cleanstone.endpoint.minecraft.vanilla.modern.entity.data.ProtocolEntityScheme;
import rocks.cleanstone.endpoint.minecraft.vanilla.modern.entity.data.ProtocolEntitySchemeMetadataEntry;
import rocks.cleanstone.endpoint.minecraft.vanilla.modern.entity.data.ProtocolEntitySchemeNode;
import rocks.cleanstone.endpoint.minecraft.vanilla.modern.entity.metadata.entrydata.EntityMetadataEntryData;
