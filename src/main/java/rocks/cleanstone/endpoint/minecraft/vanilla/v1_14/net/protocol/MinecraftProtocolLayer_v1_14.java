...
import rocks.cleanstone.endpoint.minecraft.vanilla.v1_12_2.net.protocol.inbound.*;
import rocks.cleanstone.endpoint.minecraft.vanilla.v1_12_2.net.protocol.outbound.*;
import rocks.cleanstone.endpoint.minecraft.vanilla.v1_13.net.protocol.outbound.DeclareCommandsCodec;
import rocks.cleanstone.endpoint.minecraft.vanilla.v1_13.net.protocol.outbound.OutTabCompleteCodec;
import rocks.cleanstone.endpoint.minecraft.vanilla.v1_14.net.protocol.inbound.CreativeInventoryActionCodec;
import rocks.cleanstone.endpoint.minecraft.vanilla.v1_14.net.protocol.inbound.PlayerBlockPlacementCodec;
import rocks.cleanstone.endpoint.minecraft.vanilla.v1_14.net.protocol.inbound.PlayerDiggingCodec;
import rocks.cleanstone.endpoint.minecraft.vanilla.v1_14.net.protocol.outbound.BlockChangeCodec;
import rocks.cleanstone.endpoint.minecraft.vanilla.v1_14.net.protocol.outbound.ChunkDataCodec;
import rocks.cleanstone.endpoint.minecraft.vanilla.v1_14.net.protocol.outbound.JoinGameCodec;
import rocks.cleanstone.endpoint.minecraft.vanilla.v1_14.net.protocol.outbound.UpdateViewPositionCodec;
import rocks.cleanstone.net.packet.Packet;
import rocks.cleanstone.net.protocol.PacketCodec;

import java.util.List;

import static rocks.cleanstone.endpoint.minecraft.vanilla.net.protocol.VanillaProtocolState.*;
