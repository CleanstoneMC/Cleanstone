package rocks.cleanstone.endpoint.minecraft.vanilla.net.packet;

import rocks.cleanstone.endpoint.minecraft.vanilla.net.packet.outbound.*;
...
//    ENTITY_EFFECT(EntityEffectPacket.class),
    ...
    DECLARE_COMMANDS(DeclareCommandsPacket.class);
