...
public class OutboundPlayerPacketListener {
    ...
    @EventListener
    public void onPacket(OutboundPacketEvent<? extends Packet> outboundPacketEvent) {
        ...
        PlayerOutboundPacketEvent<? extends Packet> playerEvent = new PlayerOutboundPacketEvent<>(
