...
import rocks.cleanstone.net.mcpe.packet.data.EntityAttributes;
import rocks.cleanstone.net.mcpe.packet.data.Links;
...
public class AddEntityPacket implements Packet {
    ...
    public PacketType getType() {
        return MCPEOutboundPacketType.ADD_ENTITY;
    }
}
