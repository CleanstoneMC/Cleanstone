...
import rocks.cleanstone.net.packet.minecraft.enums.BossBarColor;
import rocks.cleanstone.net.packet.minecraft.enums.BossBarDivision;
import rocks.cleanstone.net.packet.minecraft.enums.BossBarFlag;

import java.util.UUID;

public class BossBarPacket extends SendPacket {
    ...
    public PacketType getType() {
        return MinecraftSendPacketType.BOSS_BAR;
    }
}