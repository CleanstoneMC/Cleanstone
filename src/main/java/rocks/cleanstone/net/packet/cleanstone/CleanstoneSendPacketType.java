...
import rocks.cleanstone.net.packet.cleanstone.send.KeepAlive;
...
public enum CleanstoneSendPacketType implements PacketType {
    ...
    CleanstoneSendPacketType(int typeId, Class<? extends Packet> packetClass, ProtocolType protocolType) {
        this.typeId = typeId;
