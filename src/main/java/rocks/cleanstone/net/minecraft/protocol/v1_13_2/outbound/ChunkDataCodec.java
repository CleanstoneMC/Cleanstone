...
public class ChunkDataCodec implements OutboundPacketCodec<ChunkDataPacket> {
    ...
    public ChunkDataCodec(@Qualifier("protocolBlockStateMapping_v1_13_2") BlockStateMapping<Integer> blockStateMapping, VanillaBlockDataStorageFactory vanillaBlockDataStorageFactory,
