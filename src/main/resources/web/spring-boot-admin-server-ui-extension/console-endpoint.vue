<template>
    <div class="section console-view" :class="{ 'is-loading' : !hasLoaded }">
        ...
        <div class="console-view-actions" v-if="hasLoaded">
            <div class="field has-addons">
                <p class="control is-expanded">
                    <input v-model="command" v-on:keyup.enter="sendCommand" type="text" placeholder="Command"
                           class="input">
                </p>
                <p class="control">
                    <button v-on:click="sendCommand" class="button">Send</button>
                </p>
            </div>
            <div class="card panel">
                <div class="card-content">
                    <div id="consoleArea">
                        <div class="logEntry" v-for="logEntry in logEntries">
                            <div class="logBody">
        ...
        methods: {
            ...
            getConsoleLog: async function () {
                ...
                consoleData.data.forEach(line => {
                    const regex = /([0-9]{4}-[0-9]{2}-[0-9]{2} [0-9]{2}:[0-9]{2}:[0-9]{2}.[0-9]{3})  (.*)   : (.*)/gm;
